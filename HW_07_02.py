...
for line in fh:
    line=line.rstrip()
    if not 'X-DSPAM-Confidence:' in line: # if line does not contain, skip
        continue
...
# Take not of the iteration variable, (in this case line). Any other thing will result into a traceback
